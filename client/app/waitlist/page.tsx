...
import Logos from "@/components/waitlist/waitlist-logos";
...
export default function Home() {
  ...
  return (
    <main className="dark flex min-h-screen flex-col items-center overflow-x-clip pt-12 md:pt-24 bg-black">
